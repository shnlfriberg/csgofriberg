  ...
  zh: {
    translation: {
      ...
      admin: {
        ...
        details: '详情', userDetail: '用户详情', detailStats: '查看战绩', detailLeaderboards: '排行榜', detailAnalysis: '对局分析', leaderboardVisibility: '排行榜显示', leaderboardVisibilityHint: '关闭后该用户不会出现在公开排行榜中，但管理员仍可查看其理论排名。', rankPopulation: '参与排名 {{count}} 人', rankRecord: '{{wins}} 胜 / {{total}} 场 · {{rate}}', analysisIndex: '算法相似指数', analysisSamples: '有效猜测步骤', analysisConfidence: '样本置信度', analysisEntropyPercentile: '平均熵百分位', analysisTopDecile: '前 10% 选择比例', analysisLevel: { insufficient: '样本不足', common: '常见范围', elevated: '偏高，建议观察', high: '高相似，建议复核' },
  ...
  ja: {
    translation: {
      ...
      admin: {
        ...
        details: '詳細', userDetail: 'ユーザー詳細', detailStats: '戦績', detailLeaderboards: 'ランキング', detailAnalysis: '対局分析', leaderboardVisibility: 'ランキング表示', leaderboardVisibilityHint: '非表示にすると公開ランキングから除外されますが、管理者は計算上の順位を確認できます。', rankPopulation: 'ランキング参加 {{count}} 人', rankRecord: '{{wins}} 勝 / {{total}} 試合 · {{rate}}', analysisIndex: 'アルゴリズム類似指数', analysisSamples: '有効な予想ステップ', analysisConfidence: 'サンプル信頼度', analysisEntropyPercentile: '平均エントロピーパーセンタイル', analysisTopDecile: '上位 10% 選択率', analysisLevel: { insufficient: 'サンプル不足', common: '一般的な範囲', elevated: '高め・要観察', high: '高類似・要確認' },
