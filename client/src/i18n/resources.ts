  ...
  zh: {
    translation: {
      ...
      multi: {
        ...
        avgWinningGuesses: '胜场平均猜测', fastest: '最快猜中', recentWinningGuessAverage: '近 10 场胜局平均猜测', recentMatches: '最近 3 场多人对局', viewRecentMatches: '查看最近对局', noRecentMatches: '暂无多人对局记录', roundGuessSummary: '第{{round}}局 我{{me}} / 对手{{opponent}}', viewPlayerStats: '查看 {{player}} 的战绩', viewStats: '查看战绩', offline: '已离线', noGuesses: '尚未猜测',
      ...
      admin: {
        ...
        thanksTitle: '特别感谢名单', thanksNamePlaceholder: '输入需要感谢的名字', thanksNotePlaceholder: '填写感谢备注（可选）', addThanks: '添加到名单', thanksAdding: '保存中...', thanksAdded: '已加入感谢名单', thanksAlreadyListed: '该名字已在感谢名单中', thanksUpdated: '感谢内容已更新', saveThanksEdit: '保存修改', cancelThanksEdit: '取消编辑', editThanks: '编辑 {{name}}', moveThanksUp: '上移 {{name}}', moveThanksDown: '下移 {{name}}', thanksOrderSaved: '感谢名单顺序已保存', noThanks: '暂无感谢名单', deleteThanksTitle: '将 {{name}} 移出感谢名单？', deleteThanksMessage: '移除后首页将不再显示该名字。', deleteThanksConfirm: '移除', deleteThanksEntry: '移除 {{name}}', thanksDeleted: '已从感谢名单移除',
      ...
      errors: {
        ...
        FORBIDDEN: '没有权限执行此操作', USERNAME_TAKEN: '用户名已被注册', USER_NOT_FOUND: '用户不存在', INVALID_CREDENTIALS: '用户名或密码错误', SPECIAL_THANKS_LIMIT_REACHED: '感谢名单已达 10 人上限', SPECIAL_THANKS_NAME_TAKEN: '该名字已在感谢名单中', SPECIAL_THANKS_ORDER_STALE: '感谢名单已变化，请重试排序',
        ...
        NO_ACTIVE_ROUND: '当前没有进行中的小局', GUESS_LIMIT_REACHED: '本局猜测次数已用完', GUESS_COOLDOWN: '两次猜测需要间隔 2 秒',
  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        thanksTitle: 'Special Thanks List', thanksNamePlaceholder: 'Enter a name to thank', thanksNotePlaceholder: 'Add a note (optional)', addThanks: 'Add to list', thanksAdding: 'Saving...', thanksAdded: 'Added to the thanks list', thanksAlreadyListed: 'This name is already on the thanks list', thanksUpdated: 'Thanks entry updated', saveThanksEdit: 'Save changes', cancelThanksEdit: 'Cancel editing', editThanks: 'Edit {{name}}', moveThanksUp: 'Move {{name}} up', moveThanksDown: 'Move {{name}} down', thanksOrderSaved: 'Thanks list order saved', noThanks: 'The thanks list is empty', deleteThanksTitle: 'Remove {{name}} from the thanks list?', deleteThanksMessage: 'The name will no longer appear on the home page.', deleteThanksConfirm: 'Remove', deleteThanksEntry: 'Remove {{name}}', thanksDeleted: 'Removed from the thanks list',
      ...
      errors: {
        ...
        FORBIDDEN: 'You do not have permission to do that.', USERNAME_TAKEN: 'That username is already registered.', USER_NOT_FOUND: 'User not found.', INVALID_CREDENTIALS: 'Incorrect username or password.', SPECIAL_THANKS_LIMIT_REACHED: 'The special thanks list has reached its 10-name limit.', SPECIAL_THANKS_NAME_TAKEN: 'This name is already on the special thanks list.', SPECIAL_THANKS_ORDER_STALE: 'The special thanks list changed. Retry the reorder.',
        ...
        NO_ACTIVE_ROUND: 'There is no active round.', GUESS_LIMIT_REACHED: 'You have used every guess this round.', GUESS_COOLDOWN: 'Wait 2 seconds between guesses.',
  ...
  ja: {
    translation: {
      ...
      multi: {
        ...
        avgWinningGuesses: '勝利時の平均予想', fastest: '最速正解', recentWinningGuessAverage: '直近 10 試合の勝利ラウンド平均予想', recentMatches: '直近 3 件のマルチ対局', viewRecentMatches: '最近の対局を見る', noRecentMatches: 'マルチ対局履歴がありません', roundGuessSummary: '第{{round}}R 自分{{me}} / 相手{{opponent}}', viewPlayerStats: '{{player}} の戦績を見る', viewStats: '戦績を見る', offline: 'オフライン', noGuesses: 'まだ予想していません',
      ...
      admin: {
        ...
        thanksTitle: '特別感謝リスト', thanksNamePlaceholder: '感謝する名前を入力', thanksNotePlaceholder: '感謝メモを入力（任意）', addThanks: 'リストに追加', thanksAdding: '保存中...', thanksAdded: '感謝リストに追加しました', thanksAlreadyListed: 'この名前はすでにリストにあります', thanksUpdated: '感謝内容を更新しました', saveThanksEdit: '変更を保存', cancelThanksEdit: '編集をキャンセル', editThanks: '{{name}} を編集', moveThanksUp: '{{name}} を上へ移動', moveThanksDown: '{{name}} を下へ移動', thanksOrderSaved: '感謝リストの順序を保存しました', noThanks: '感謝リストは空です', deleteThanksTitle: '{{name}} を感謝リストから削除しますか？', deleteThanksMessage: 'ホーム画面にこの名前が表示されなくなります。', deleteThanksConfirm: '削除', deleteThanksEntry: '{{name}} を削除', thanksDeleted: '感謝リストから削除しました',
      ...
      errors: {
        ...
        FORBIDDEN: 'この操作を行う権限がありません。', USERNAME_TAKEN: 'このユーザー名は既に登録されています。', USER_NOT_FOUND: 'ユーザーが見つかりません。', INVALID_CREDENTIALS: 'ユーザー名またはパスワードが正しくありません。', SPECIAL_THANKS_LIMIT_REACHED: '特別感謝リストは 10 名の上限に達しています。', SPECIAL_THANKS_NAME_TAKEN: 'この名前はすでに特別感謝リストにあります。', SPECIAL_THANKS_ORDER_STALE: '特別感謝リストが変更されました。並べ替えを再試行してください。',
        ...
        NO_ACTIVE_ROUND: '進行中のラウンドがありません。', GUESS_LIMIT_REACHED: 'このラウンドの予想回数を使い切りました。', GUESS_COOLDOWN: '予想の間隔は 2 秒必要です。',
