  ...
  zh: {
    translation: {
      ...
      multi: {
        ...
        startGame: '开始对局', cancelReady: '取消准备', readyAction: '准备', readyOpponentLeft: '对手已退出准备，匹配已取消', readyTimedOutPenalized: '准备超时，{{seconds}} 秒后可再次匹配', readyTimedOutOpponent: '对手准备超时，匹配已取消', readyExitCooldown: '已退出准备，{{seconds}} 秒后可再次匹配', myGuesses: '我的猜测', roundDraw: '本局平局', roundWon: '本局获胜', roundLost: '本局失利',
  ...
  en: {
    translation: {
      ...
      multi: {
        ...
        startGame: 'Start match', cancelReady: 'Cancel ready', readyAction: 'Ready', readyOpponentLeft: 'Your opponent left the ready check. Matchmaking was cancelled.', readyTimedOutPenalized: 'Ready check timed out. You can match again in {{seconds}}s.', readyTimedOutOpponent: 'Your opponent timed out during the ready check.', readyExitCooldown: 'You left the ready check. You can match again in {{seconds}}s.', myGuesses: 'My guesses', roundDraw: 'Round draw', roundWon: 'Round won', roundLost: 'Round lost',
