  ...
  zh: {
    translation: {
      ...
      rules: {
        ...
        multiSurrender: '点击“跳过本轮”后本轮不能继续猜，对方会看到跳过状态。双方都跳过，或另一方用完次数后，本轮揭晓答案并按平局处理。',
      ...
      multi: {
        ...
        playerDatabase: '选手数据库', formatLabel: '赛制', createRoom: '创建房间', creating: '创建中…', randomMatch: '随机匹配', fixedBo3: '自动寻找已完成邮箱验证的对手，赛制固定为 BO3', searching: '正在寻找对手...',
        ...
        skipTitle: '跳过本轮？', skipMessage: '跳过后本轮不能继续猜，对方会看到你的跳过状态。双方都跳过，或对方用完猜测次数后，本轮将揭晓答案并按平局处理。', skipConfirm: '确认跳过本轮',
        ...
        roundReasons: { guessed: '猜中目标', exhausted: '双方次数用尽', timeout: '本局时间到', skipped: '双方跳过或剩余一方次数用尽', surrender: '一方选择本轮投降' },
      },
      leaderboard: {
      ...
      admin: {
        ...
        importDone: '导入完成：新增 {{created}}，更新 {{updated}}', jsonError: 'JSON 格式错误', nickname: '昵称', nationality: '国家或地区', region: '赛区', team: '队伍', age: '年龄', role: '位置', majorTitles: 'Major 冠军', major: 'Major', difficulties: '难度', status: '状态', pool: '选手池', actions: '操作',
      ...
      errors: {
        ...
        NO_ACTIVE_ROUND: '当前没有进行中的小局', GUESS_LIMIT_REACHED: '本局猜测次数已用完', ROUND_SKIPPED: '你已跳过本轮，不能继续猜测', GUESS_COOLDOWN: '两次猜测需要间隔 1.5 秒',
  ...
  en: {
    translation: {
      ...
      rules: {
        ...
        multiReveal: 'During the 6-second results phase, every guess from both players is revealed.', multiSurrender: 'Skip Round stops your guesses and shows your skipped state to the other player. If both players skip, or the other player uses every guess, the answer is revealed and the round is a draw.',
      ...
      multi: {
        ...
        playerDatabase: 'Player database', formatLabel: 'Format', createRoom: 'Create room', creating: 'Creating…', randomMatch: 'Quick Match', fixedBo3: 'Automatically find a verified-email opponent. Format is fixed to BO3.', searching: 'Finding an opponent...',
        ...
        skipTitle: 'Skip this round?', skipMessage: 'You cannot guess again this round, and the other player will see that you skipped. If both players skip, or the other player uses every guess, the answer is revealed and the round is a draw.', skipConfirm: 'Skip round',
        ...
        roundReasons: { guessed: 'Target guessed', exhausted: 'Both players used every guess', timeout: 'Round timer expired', skipped: 'Both players skipped or the remaining player used every guess', surrender: 'A player surrendered the round' },
      },
      leaderboard: {
      ...
      admin: {
        ...
        importDone: 'Import complete: {{created}} created, {{updated}} updated', jsonError: 'Invalid JSON', nickname: 'Nickname', nationality: 'Country or region', region: 'Region', team: 'Team', age: 'Age', role: 'Role', majorTitles: 'Major titles', major: 'Majors', difficulties: 'Difficulties', status: 'Status', pool: 'Player pool', actions: 'Actions',
      ...
      errors: {
        ...
        NO_ACTIVE_ROUND: 'There is no active round.', GUESS_LIMIT_REACHED: 'You have used every guess this round.', ROUND_SKIPPED: 'You skipped this round and cannot guess again.', GUESS_COOLDOWN: 'Wait 1.5 seconds between guesses.',
  ...
  ja: {
    translation: {
      ...
      rules: {
        ...
        multiSurrender: '「このラウンドをスキップ」を押すと以後は予想できず、相手にもスキップ状態が表示されます。双方がスキップするか、残りのプレイヤーが予想回数を使い切ると、正解を表示して引き分けになります。', regionsTitle: '国・地域の区分',
      ...
      multi: {
        ...
        playerDatabase: '選手データベース', formatLabel: '形式', createRoom: 'ルーム作成', creating: '作成中…', randomMatch: 'ランダムマッチ', fixedBo3: 'メール確認済みの対戦相手を自動で探します。形式は BO3 固定です。', searching: '対戦相手を検索中...',
        ...
        skipTitle: 'このラウンドをスキップしますか？', skipMessage: 'スキップ後はこのラウンドで予想できず、相手にも状態が表示されます。双方がスキップするか、相手が予想回数を使い切ると、正解を表示して引き分けになります。', skipConfirm: 'ラウンドをスキップ',
        ...
        roundReasons: { guessed: '正解を当てた', exhausted: '双方が予想回数を使い切った', timeout: 'ラウンド時間終了', skipped: '双方がスキップ、または残りの一方が予想回数を使い切った', surrender: '一方がラウンドを降参' },
      },
      leaderboard: {
      ...
      admin: {
        ...
        importDone: 'インポート完了：追加 {{created}}、更新 {{updated}}', jsonError: 'JSON 形式が正しくありません', nickname: 'ニックネーム', nationality: '国・地域', region: '地域', team: 'チーム', age: '年齢', role: '役割', majorTitles: 'Major 優勝', major: 'Major', difficulties: '難易度', status: '状態', pool: '選手プール', actions: '操作',
      ...
      errors: {
        ...
        NO_ACTIVE_ROUND: '進行中のラウンドがありません。', GUESS_LIMIT_REACHED: 'このラウンドの予想回数を使い切りました。', ROUND_SKIPPED: 'このラウンドはスキップ済みのため、これ以上予想できません。', GUESS_COOLDOWN: '予想の間隔は 1.5 秒必要です。',
