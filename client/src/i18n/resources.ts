  ...
  en: {
    translation: {
      ...
      home: {
        ...
        multiplayerDescription: 'Create a room or find a match', stats: 'Stats / Replays', leaderboard: 'Leaderboard', announcements: 'Updates', bilibili: 'Bilibili: 怂皇的一天', github: 'GitHub', specialThanks: 'Special Thanks', closeSpecialThanks: 'Close special thanks',
      },
      rules: {
  ...
  ja: {
    translation: {
      ...
      home: {
        ...
        multiplayer: 'マルチプレイ', multiplayerDescription: 'ルーム作成またはランダムマッチ', stats: '統計 / リプレイ', leaderboard: 'ランキング', announcements: '更新情報', bilibili: 'Bilibili：怂皇的一天', github: 'GitHub', specialThanks: '特別感謝', closeSpecialThanks: '特別感謝を閉じる',
      },
      rules: {
