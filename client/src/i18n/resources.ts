  ...
  zh: {
    translation: {
      ...
      multi: {
        ...
        playerDatabase: '选手数据库', formatLabel: '赛制', createRoom: '创建房间', creating: '创建中…', randomMatch: '随机匹配', fixedBo3: '自动寻找对手，赛制固定为 BO3', searching: '正在寻找对手...',
        cancelMatch: '取消匹配', startMatch: '开始匹配', verifiedOnly: '仅匹配已验证邮箱用户', matchmakingCooldown: '匹配冷却中，请在 {{seconds}} 秒后重试', matchmakingCooldownButton: '冷却 {{seconds}} 秒', joinExisting: '加入已有房间', joinHint: '输入房间码后按回车加入', roomCodePlaceholder: '5 位房间码', join: '加入', spectate: '观战',
  ...
  en: {
    translation: {
      ...
      multi: {
        ...
        playerDatabase: 'Player database', formatLabel: 'Format', createRoom: 'Create room', creating: 'Creating…', randomMatch: 'Quick Match', fixedBo3: 'Automatically find an opponent. Format is fixed to BO3.', searching: 'Finding an opponent...',
        cancelMatch: 'Cancel search', startMatch: 'Find match', verifiedOnly: 'Match verified-email users only', matchmakingCooldown: 'Matchmaking is cooling down. Try again in {{seconds}}s.', matchmakingCooldownButton: 'Cooldown {{seconds}}s', joinExisting: 'Join a Room', joinHint: 'Enter a room code and press Enter', roomCodePlaceholder: '5-character code', join: 'Join', spectate: 'Spectate',
  ...
  ja: {
    translation: {
      ...
      multi: {
        ...
        playerDatabase: '選手データベース', formatLabel: '形式', createRoom: 'ルーム作成', creating: '作成中…', randomMatch: 'ランダムマッチ', fixedBo3: '対戦相手を自動で探します。形式は BO3 固定です。', searching: '対戦相手を検索中...',
        cancelMatch: '検索をキャンセル', startMatch: 'マッチ検索', verifiedOnly: '確認済みメールのユーザーのみ', matchmakingCooldown: 'マッチングはクールダウン中です。{{seconds}} 秒後に再試行してください。', matchmakingCooldownButton: 'クールダウン {{seconds}} 秒', joinExisting: 'ルームに参加', joinHint: 'ルームコードを入力して Enter', roomCodePlaceholder: '5 文字のコード', join: '参加', spectate: '観戦',
