  ...
  zh: {
    translation: {
      ...
      admin: {
        ...
        reportsTitle: '对局举报管理', totalReports: '共 {{count}} 条举报', reportCreatedAt: '举报时间', reporter: '举报方', reportedUser: '被举报方', reportMatch: '对局', reportDescription: '举报描述', reportNoDescription: '未填写描述', reportStatusLabel: '处理状态', reportStatus: { all: '全部', pending: '待处理', resolved: '已处理', dismissed: '已驳回' }, handleReport: '处理举报', reportHandled: '举报处理结果已保存', reportAdminNote: '管理员备注', reportAdminNotePlaceholder: '填写处理记录，最多 500 字', saveReport: '保存处理结果', noReports: '暂无符合条件的举报',
  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        reportsTitle: 'Match Report Management', totalReports: '{{count}} reports', reportCreatedAt: 'Reported at', reporter: 'Reporter', reportedUser: 'Reported player', reportMatch: 'Match', reportDescription: 'Description', reportNoDescription: 'No description provided', reportStatusLabel: 'Status', reportStatus: { all: 'All', pending: 'Pending', resolved: 'Resolved', dismissed: 'Dismissed' }, handleReport: 'Process report', reportHandled: 'Report status saved', reportAdminNote: 'Admin note', reportAdminNotePlaceholder: 'Record the outcome, up to 500 characters', saveReport: 'Save result', noReports: 'No matching reports',
  ...
  ja: {
    translation: {
      ...
      admin: {
        ...
        reportsTitle: '対局通報管理', totalReports: '通報 {{count}} 件', reportCreatedAt: '通報日時', reporter: '通報者', reportedUser: '通報対象', reportMatch: '対局', reportDescription: '通報内容', reportNoDescription: '内容なし', reportStatusLabel: '処理状態', reportStatus: { all: 'すべて', pending: '未処理', resolved: '処理済み', dismissed: '却下' }, handleReport: '通報を処理', reportHandled: '処理結果を保存しました', reportAdminNote: '管理者メモ', reportAdminNotePlaceholder: '処理内容を 500 文字以内で入力', saveReport: '処理結果を保存', noReports: '該当する通報はありません',
