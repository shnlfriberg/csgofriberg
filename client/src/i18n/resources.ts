  ...
  zh: {
    translation: {
      ...
      multi: {
        ...
        cancelMatch: '取消匹配', startMatch: '开始匹配', matchVerifiedRequired: '随机匹配仅对已登录且完成邮箱验证的用户开放。', matchmakingCooldown: '匹配冷却中，请在 {{seconds}} 秒后重试', matchmakingCooldownButton: '冷却 {{seconds}} 秒', joinExisting: '加入已有房间', joinHint: '输入房间码后按回车加入', roomCodePlaceholder: '5 位房间码', join: '加入', spectate: '观战',
      ...
      admin: {
        ...
        title: '管理后台', presence: '实时在线统计', online: '在线人数', multiRooms: '多人房间', singleGames: '单人游戏', playersTab: '选手管理', difficultiesTab: '难度管理', usersTab: '用户管理', guestsTab: '访客管理', announcementsTab: '公告管理', apiTokensTab: 'API Token', resourcesTab: '资源版本',
  ...
  en: {
    translation: {
      ...
      multi: {
        ...
        cancelMatch: 'Cancel search', startMatch: 'Find match', matchVerifiedRequired: 'Quick Match is available only to signed-in users with a verified email.', matchmakingCooldown: 'Matchmaking is cooling down. Try again in {{seconds}}s.', matchmakingCooldownButton: 'Cooldown {{seconds}}s', joinExisting: 'Join a Room', joinHint: 'Enter a room code and press Enter', roomCodePlaceholder: '5-character code', join: 'Join', spectate: 'Spectate',
      ...
      admin: {
        ...
        title: 'Admin Panel', presence: 'Live presence', online: 'Online users', multiRooms: 'Multiplayer rooms', singleGames: 'Solo games', playersTab: 'Players', difficultiesTab: 'Difficulties', usersTab: 'Users', guestsTab: 'Guests', announcementsTab: 'Announcements', apiTokensTab: 'API tokens', resourcesTab: 'Resource version',
  ...
  ja: {
    translation: {
      ...
      multi: {
        ...
        cancelMatch: '検索をキャンセル', startMatch: 'マッチ検索', matchVerifiedRequired: 'ランダムマッチはログインしてメール確認を完了したユーザーのみ利用できます。', matchmakingCooldown: 'マッチングはクールダウン中です。{{seconds}} 秒後に再試行してください。', matchmakingCooldownButton: 'クールダウン {{seconds}} 秒', joinExisting: 'ルームに参加', joinHint: 'ルームコードを入力して Enter', roomCodePlaceholder: '5 文字のコード', join: '参加', spectate: '観戦',
      ...
      admin: {
        ...
        title: '管理画面', presence: 'リアルタイム接続状況', online: 'オンライン人数', multiRooms: 'マルチルーム', singleGames: 'ソロゲーム', playersTab: '選手管理', difficultiesTab: '難易度管理', usersTab: 'ユーザー管理', guestsTab: 'ゲスト管理', announcementsTab: 'お知らせ管理', apiTokensTab: 'API トークン', resourcesTab: 'リソースバージョン',
